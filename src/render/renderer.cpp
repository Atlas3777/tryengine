...
void Renderer::SetupColorTargetDescription(SDL_GPUColorTargetDescription *colorTargetDesc, SDL_GPUDevice *device, SDL_Window *window)
{
    colorTargetDesc[0] = {};
    ...
    colorTargetDesc[0].blend_state.src_color_blendfactor =
        SDL_GPU_BLENDFACTOR_SRC_ALPHA;
    colorTargetDesc[0].blend_state.dst_color_blendfactor =
        SDL_GPU_BLENDFACTOR_ONE_MINUS_SRC_ALPHA;
    colorTargetDesc[0].blend_state.src_alpha_blendfactor =
        SDL_GPU_BLENDFACTOR_SRC_ALPHA;
    colorTargetDesc[0].blend_state.dst_alpha_blendfactor =
        SDL_GPU_BLENDFACTOR_ONE_MINUS_SRC_ALPHA;
    colorTargetDesc[0].format =
...
void Renderer::SetupVertexBufferDescription(SDL_GPUVertexBufferDescription *vertexBufferDesc)
{
...
SDL_GPUGraphicsPipeline* Renderer::CreateGraphicsPipeline(
