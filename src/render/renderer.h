...
public:
    ...
    void SetupColorTargetDescription(SDL_GPUColorTargetDescription *colorTargetDesc, SDL_GPUDevice *device, SDL_Window *window);
    SDL_GPUSampler* CreateSampler(SDL_GPUDevice &device);
    void SetupVertexBufferDescription(SDL_GPUVertexBufferDescription *vertexBufferDesc);
