...
SDL_GPUShader* Renderer::CreateVertexShader(SDL_GPUDevice& device) {
    ...
    void* vertexCode = SDL_LoadFile("engine/assets/shaders/vertex.spv", &vertexCodeSize);
...
SDL_GPUShader* Renderer::CreateFragmentShader(SDL_GPUDevice& device) {
    ...
    void* fragmentCode = SDL_LoadFile("engine/assets/shaders/fragment.spv", &fragmentCodeSize);
